<template>
  <div class="w-full mt-8 max-w-screen-lg flex px-6">
    <div class="w-full flex flex-col mr-4 overflow-hidden sticky top-6 h-max">
    ...
    <div class="w-screen-sm flex-shrink-0">
